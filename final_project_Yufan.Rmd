...
All data were download from: https://xenabrowser.net/datapages/
...
Spearman’s rank correlation test will be used to assess the strength of the relationship between each classical T cell biomarkers with rest of 50,000 genes.
...
**345 overlapping genes were selected out**
...
**Venn diagram for top 5 biomarker genes**
...
I identitified around two hundreds potential signatures of T cell dysfunction from pancreatic tumor cohort by testing how the expression of each gene in tumor interacts with the classiscal T cell specific dysfunction biomarkers. These potential T cell dysfunction genes were highly correlated with T cell activation and was correlated with poor survival rate. It is possible that overlapping intergradted correlation analysis could be applied to find biomarker related candidate signature genes. This workflow could be implemented in other TCGA cancer type cohorts to indentify candidate genes.
